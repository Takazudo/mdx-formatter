...
// Use require for JSON data files to avoid TypeScript module issues
const sidebars = require('@site/sidebars');
const categoryNav = require('@site/src/data/category-nav.json');
const docTitles = require('@site/src/data/doc-titles.json');
...
export default function DocsSitemap(): ReactNode {
  ...
  const sidebarEntries = Object.entries(
    sidebars.default || sidebars,
  ) as Array<[string, SidebarItem[]]>;
