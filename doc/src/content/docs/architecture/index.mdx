...
| `replaceHtmlBlock` | Replace an HTML block with properly indented output |
...
| 3 | `formatHtmlBlocksInMdx` | on | Format HTML blocks with proper indentation |
