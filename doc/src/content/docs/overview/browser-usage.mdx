...
The WASM module provides the same Rust formatting engine that powers the Node.js package, compiled to WebAssembly. See the [Playground](/docs/playground) for a live example.
