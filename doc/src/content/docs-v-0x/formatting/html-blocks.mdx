...
The formatter properly indents HTML blocks within MDX content. This is controlled by the [formatHtmlBlocksInMdx](../options/format-html-blocks-in-mdx) option and uses Prettier under the hood.
