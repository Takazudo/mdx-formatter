...
| `specific-rules.test.ts` | Individual rules | Detailed tests for each of the 10 rules |
...
| 3 | Idempotency | 9 |
| 4 | MDX/JSX Preservation | 12 |
| 5a | Parsing — CommonMark | 16 |
| 5b | Parsing — GFM | 4 |
| 5c | Parsing — MDX | 6 |
